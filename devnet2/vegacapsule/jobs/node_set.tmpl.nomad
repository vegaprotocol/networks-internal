...
locals {
  ...
  tendermint_artifacts = {
    "/tmp/local/vega/.tendermint/config" = {
      path = "{{- $netName -}}/tendermint/node{{ .Index }}/config"
      mode = "dir"
    }
    "/tmp/local/vega/.tendermint/data/priv_validator_state.json" = {
      path = "{{- $netName -}}/tendermint/node{{ .Index }}/data/priv_validator_state.json"
      mode = "file"
    }
  }
  ...
  data_node_artifacts = {
    "/tmp/local/vega/.data-node/config" = {
      path = "{{- $netName -}}/data/node{{ .Index }}/config"
      mode = "dir"
    }
  }
  ...
  vega_artifacts = {
    "/tmp/local/vega/.vega/config" = {
      path = "{{- $netName -}}/vega/node{{ .Index }}/config"
      mode = "dir"
    }

    "/tmp/local/vega/.vega/data" = {
      path = "{{- $netName -}}/vega/node{{ .Index }}/data"
      mode = "dir"
    }

    "/tmp/local/vega/.vega/node-vega-wallet-pass.txt" = {
      path = "{{- $netName -}}/vega/node{{ .Index }}/node-vega-wallet-pass.txt"
      mode = "file"
    }
  }
  ...
  vega_validator_artifacts = {
    "/tmp/local/vega/.vega/ethereum-vega-wallet-pass.txt" = {
      path = "{{- $netName -}}/vega/node{{ .Index }}/ethereum-vega-wallet-pass.txt"
      mode = "file"
    }

    "/tmp/local/vega/.vega/vega-wallet-pass.txt" = {
      path = "{{- $netName -}}/vega/node{{ .Index }}/vega-wallet-pass.txt"
      mode = "file"
    }
  }
